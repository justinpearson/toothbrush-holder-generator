    ...
    <section className="controls__group" aria-label="Global defaults">
      ...
      >
        <p className="controls__hint">
          Objects use these unless they override below.
        </p>
        <p className="controls__hint">
          Object diameter is the item the holder holds (e.g. a 26 mm
          toothbrush). A tube&apos;s bore is object diameter + padding; its
          printed outer size adds a wall on each side.
        </p>
        <Slider
          label="Object diameter"
          value={g.objectDiameter}
